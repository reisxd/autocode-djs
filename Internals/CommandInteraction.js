...
class CommandInteraction {
  constructor(context, lib) {
    ...
    this.commandId = context.params.event.data.id;
    this.commandName = context.params.event.data.name;
  ...
  async followUp(args) {
    ...
    return await lib.discord.interactions['@1.0.1'].followups.create(followUp);
  }
